#!/usr/bin/env python3
"""
Generate an index of sections and functions from research_notebook.html
...
def format_markdown(sections: list[Section]) -> str:
    ...
    output = []
    output.append("# research_notebook.html - Section Index\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate index of sections and functions from research_notebook.html"
    )
    parser.add_argument(
        '--section', '-s',
        type=str,
    ...
    parser.add_argument(
        '--file', '-f',
        type=str,
        default='research_notebook.html',
        help='Path to HTML file (default: research_notebook.html)'
    )
