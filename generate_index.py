#!/usr/bin/env python3
"""
Generate an index of sections and functions from js/app.js
...
The script parses section markers:
    // ========== SECTION: NAME ==========
...
def parse_js_file(filepath: Path) -> tuple[list[Section], list[str]]:
    """Parse the JS file and extract sections and functions."""
...
def format_markdown(sections: list[Section]) -> str:
    ...
    output = []
    output.append("# js/app.js - Section Index\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate index of sections and functions from js/app.js"
    )
    parser.add_argument(
        '--section', '-s',
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default='js/app.js',
        help='Path to JS file (default: js/app.js)'
    )
    ...
    sections, lines = parse_js_file(filepath)
