...
// Global data structure, state variables, editing trackers, marked config
// Note: Utility functions in js/utilities.js, Pyodide runtime in js/pyodide.js
...
// Pyodide state - now managed in js/pyodide.js module
...
// Now in js/utilities.js module

// ========== SECTION: RENDER_FUNCTIONS ==========
// Main render and template buttons: render, renderTemplateButtons, findNote, findCode
// Note: Generic renderCard() and openViewer() are in TEMPLATE_SYSTEM section
// Note: escapeHtml() now in js/utilities.js module
...
// escapeHtml() now in js/utilities.js module
